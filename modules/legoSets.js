...
const PGHOST = 'ep-twilight-sea-a54ublhh-pooler.us-east-2.aws.neon.tech';
const PGDATABASE = 'senecadb';
const PGUSER = 'senecadb_owner';
const PGPASSWORD = 'PtMOzQq24vGV';
...
async function initialize() {
  try {
    ...
    // Synchronize models with the database and insert existing data
